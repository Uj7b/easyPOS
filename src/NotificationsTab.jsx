      ...
      >
        <div className="bg-white p-4 rounded-xl shadow-xl w-[700px] h-[500px]">
          <div className="modal-header flex justify-between h-fit text-2xl">
            ...
            <button className="cursor-pointer h-7 w-7 flex justify-center items-center aspect-square rounded-full text-gray-500"><RiCloseLargeLine></RiCloseLargeLine></button>
          </div>
